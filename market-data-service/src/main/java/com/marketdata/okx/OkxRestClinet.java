...
public class OkxRestClinet {
	...
	private static final String OKX_TICKERS_URL = "https://openapi.okx.com/api/v5/market/tickers?instType=SPOT";
	...
	public String marketData() {
		try {
			HttpRequest request = HttpRequest.newBuilder().uri(URI.create(OKX_TICKERS_URL)).timeout(Duration.ofSeconds(20))
